...
<footer class="spacer">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <h4>Anka Beach Resort</h4>
                    <p>Welcome to the Anka Beach Resort. Located at the world-renowned Mombasa, Kenya Beach over a sprawling and serene area, experience the majestic splendour surrounded by spectacular sunsets, heavenly blues and hues of a secluded sandy beach, nestled on the shores of the Indian Ocean.</p>
                </div>              
                 ...
                 <div class="col-sm-4 subscribe">
                    ...
                    <button class="btn btn-default" type="button">Get Notify</button> <a href="info@ankalimited.co.ke">
                    </span>
                    </div>
                    <div class="social">
...
<div class="text-center copyright">Powered by <a href=""> Jamal Mk</a></div>
